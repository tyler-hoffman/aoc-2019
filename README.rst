...
advent of code 2019
===================
.. image:: https://github.com/tyler-hoffman/aoc-2019/actions/workflows/poetry.yml/badge.svg
...
+---------------------------------+-------------------------------------------------------------------------------------------------+
| Run solution file               | ``poetry run python -m aoc_2019.day_<DAY>.<PART>``                                              |
+---------------------------------+-------------------------------------------------------------------------------------------------+
...
* `AoC <https://adventofcode.com/2019>`_
* `Repo <https://github.com/tyler-hoffman/aoc-2019>`_
